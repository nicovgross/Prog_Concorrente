...
int main(int argc, char* argv[]) {
    ...
    //carrega o vetor
    if(carregaEntrada(descritorArquivoVetor, &mat2, &linhasMat2, &colunasMat2)) //'vet' esta no escopo global
        return 3;
    ...
    printMatriz(mat1, linhasMat1, colunasMat1); printf("\n");
    printMatriz(mat2, linhasMat2, colunasMat2); printf("\n");
    printMatriz(saida, linhasMat1, colunasMat2);
